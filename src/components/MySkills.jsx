        ...
        <div id='skills' className='my-24'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-5 gap-6 mt-6 text-center'>
                ...
                <div className='border border-gray-400 rounded-lg p-6 hover:shadow-black hover:bg-[#fcf4ff]'>
                    ...
                    <h2 className="font-medium text-lg">React</h2>
                </div>
            </div>
            ...
            <h3 className='text-2xl mt-10 text-center'>Backend</h3>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 text-center mx-auto md:w-3/5'>
                <div className='border border-gray-400 rounded-lg p-6 hover:shadow-black hover:bg-[#fcf4ff]'>
                    ...
                    <h2 className="font-medium text-lg">Firebase</h2>
                </div>
                <div className='border border-gray-400 rounded-lg p-6 hover:shadow-black hover:bg-[#fcf4ff]'>
                    <svg className='mx-auto' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                    ...
                    <h2 className="font-medium text-lg">MongoDB</h2>
                </div>
                <div className='border border-gray-400 rounded-lg p-6 hover:shadow-black hover:bg-[#fcf4ff]'>
                    ...
                    <h2 className="font-medium text-lg">Express JS</h2>
                </div>
            </div>
        </div>
    );
